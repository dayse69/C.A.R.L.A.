...
// Criar embed de erro
function criarEmbedErro(mensagem) {
...
function criarEmbedVazio(categoria) {
    return new EmbedBuilder()
        .setColor("#8B00FF")
...
function criarEmbedOrigens(origens) {
...
function criarEmbedRacas(racas) {
...
function criarEmbedClasses(classes, page = 0) {
...
function criarEmbedClassesAlternativas(classes, page = 0) {
    if (!classes || classes.length === 0) {
...
function criarEmbedPoderesGerais(poderes) {
...
function criarEmbedDeuses(deuses, tipo) {
...
function criarEmbedDistincoes(distincoes) {
...
function criarEmbedGenerico(categoria, dados) {
