...
createResponder({
    ...
    async run(interaction) {
        ...
        const atributosInput = new TextInputBuilder()
            ...
            .setRequired(false)
            .setMaxLength(400);
        modal.addComponents(new ActionRowBuilder().addComponents(descricaoInput), new ActionRowBuilder().addComponents(requisitosInput), new ActionRowBuilder().addComponents(atributosInput));
