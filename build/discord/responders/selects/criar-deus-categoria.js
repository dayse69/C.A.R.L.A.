...
createResponder({
    ...
    async run(interaction) {
        ...
        const requisitosInput = new TextInputBuilder()
            ...
            .setRequired(false);
        modal.addComponents(new ActionRowBuilder().addComponents(descricaoInput), new ActionRowBuilder().addComponents(atributosInput), new ActionRowBuilder().addComponents(requisitosInput));
