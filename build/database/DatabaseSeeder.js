...
export class DatabaseSeeder {
     ...
     * Seed de raças
     */
    static async seedRaces() {
        const races = [
            {
                id: "humano",
                nome: "Humano",
                descricao: "Versáteis e ambiciosos, os humanos são encontrados em todo o mundo de Tormenta 20.",
            ...
            },
            {
                id: "anao",
                nome: "Anão",
                descricao: "Resistentes e fortes, os anões vivem nas montanhas e profundezas da terra.",
            ...
            },
            {
                id: "meio_orc",
                nome: "Meio-Orc",
                descricao: "Filhos de dois mundos, os meio-orcs frequentemente enfrentam preconceito.",
                bônus: { FOR: 2, CAR: -1 },
        ...
        if (count === 0) {
            await collections.compendium_races.insertMany(races);
    ...
    static async seedClasses() {
        const classes = [
            ...
            },
            {
                id: "mago",
                nome: "Mago",
                descricao: "Canalizadores de magia arcana, os magos usam feitiços para controlar a batalha.",
        ...
        if (count === 0) {
            await collections.compendium_classes.insertMany(classes);
    ...
    static async seedPowers() {
        ...
        if (count === 0) {
            await collections.compendium_powers.insertMany(powers);
    ...
    static async seedSpells() {
        ...
        if (count === 0) {
            await collections.compendium_spells.insertMany(spells);
    ...
    static async seedItems() {
        ...
        if (count === 0) {
            await collections.compendium_items.insertMany(items);
