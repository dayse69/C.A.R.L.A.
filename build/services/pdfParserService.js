 ...
 */
export function parsearFichaPDF(textoExtraido) {
    const ficha = {
        nome: "",
        raca: "",
        classe: "",
 ...
 */
export function converterParaCharacter(fichaExtraida, usuarioId) {
    return {
        ...
        recursos: {
            pv: {
                atual: Math.floor((fichaExtraida.atributos.CON - 10) / 2) +
                    12 +
                    (fichaExtraida.nivel - 1) * 3,
                maximo: Math.floor((fichaExtraida.atributos.CON - 10) / 2) +
                    12 +
                    (fichaExtraida.nivel - 1) * 3,
                temporario: 0,
            },
