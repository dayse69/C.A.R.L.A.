 ...
 */
export function calcularReacoesDisponiveis(nivel) {
 ...
 */
export function usarReacao(reacoes, reacaoId) {
 ...
 */
export function restaurarReacoes(reacoes) {
    reacoes.forEach((r) => {
 ...
 */
export function restaurarReacoesCombate(reacoes) {
    reacoes.forEach((r) => {
