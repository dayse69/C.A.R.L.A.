 ...
 */
export function rolarDado(tipo) {
 ...
 */
export function rolarMultiplosDados(quantidade, tipo) {
    const rolls = [];
 ...
 */
export function rolarPericia(modificador, descricao = "Teste") {
    const d20 = rolarD20();
 ...
 * Rola um ataque
 */
export function rolarAtaque(modificadorAtaque, modificadorDano, dadoDano = "d6") {
    const d20 = rolarD20();
 ...
 */
export function formatarResultadoRolagem(resultado) {
    const emoji = {
        sucesso: "✅",
        fracasso: "❌",
        critico: "✨",
 ...
 */
export function interpretarTeste(resultado, dc) {
    const margemSucesso = resultado - dc;
    const sucesso = resultado >= dc;
    let descricao = "";
    if (margemSucesso >= 10)
        descricao = "Sucesso extraordinário!";
    else if (margemSucesso >= 5)
        descricao = "Sucesso bom!";
    else if (sucesso)
        descricao = "Sucesso por pouco!";
    else if (margemSucesso >= -5)
        descricao = "Falha por pouco!";
    else
