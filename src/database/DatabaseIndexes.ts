...
export class DatabaseIndexes {
     ...
     */
    private static async createCharacterIndexes(): Promise<void> {
     ...
     */
    private static async createCompendiumIndexes(): Promise<void> {
        const {
            compendium_classes,
            compendium_races,
            compendium_powers,
     ...
     */
    static async listAllIndexes(): Promise<void> {
        if (!isConnected()) {
